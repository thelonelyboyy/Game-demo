...
- `run_godot_checks.py`：2026-07-13 最近一次全量运行 33 项检查全部通过，覆盖主流程、卡牌生命周期与牌库操控、法宝生命周期/手牌状态/牌组结构、状态法障、战斗减益与反制、三章内容、普通敌人战术、9 Boss、精英战术、通用首领法宝、心魔难度、通用/魔修法宝与魔契、奖励经济与批量模拟、分章事件、合炼、战绩和篝火选择。
