...
CHECKS = [
    ...
    {"name": "card-keyword-standardization", "args": ["res://test_data/card_keyword_standardization_smoke.tscn"], "quit": False, "required_marker": "CARD_KEYWORD_STANDARDIZATION_SMOKE_OK"},
    ...
    {"name": "map-legend-interaction", "args": ["res://test_data/map_legend_interaction_smoke.tscn"], "quit": False, "required_marker": "MAP_LEGEND_INTERACTION_SMOKE_OK"},
    ...
    {"name": "hand-state-relic", "args": ["res://test_data/hand_state_relic_smoke.tscn"], "quit": False, "required_marker": "HAND_STATE_RELIC_SMOKE_OK"},
    {"name": "deck-shape-relic", "args": ["res://test_data/deck_shape_relic_smoke.tscn"], "quit": False, "required_marker": "DECK_SHAPE_RELIC_SMOKE_OK"},
