...
2. Create a new Card Resource (sample_trickster.tres)
3. Create a new Script, based on the Card template. (sample_trickster.gd)
...
1. Create a new Card Resource (sample_sharp_knife.tres)
2. Create a new Script, based on the Card template. (sample_sharp_knife.gd)
...
2. Create a new Card Resource (sample_angry_anvil.tres)
3. Create a new Script, based on the Card template. (sample_angry_anvil.gd)
4. Assign it to the new Card Resource
5. Test it.
6. Add it to the pool of draftable cards so it can appear in Shops and BattleRewards!
