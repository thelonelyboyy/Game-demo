...
func _apply_visuals() -> void:
	...
	add_theme_stylebox_override("normal", _make_style(Color(0.045, 0.030, 0.028, 0.90), Color(0.58, 0.38, 0.20, 0.84), 2, Color(0, 0, 0, 0.46), 12))
	add_theme_stylebox_override("hover", _make_style(Color(0.085, 0.045, 0.040, 0.96), accent_color.lightened(0.12), 2, Color(accent_color.r, accent_color.g, accent_color.b, 0.22), 16))
	add_theme_stylebox_override("pressed", _make_style(Color(0.030, 0.020, 0.020, 0.98), Color("f2c94f"), 2, Color(0, 0, 0, 0.36), 8))
	add_theme_stylebox_override("focus", StyleBoxEmpty.new())

	icon_frame.add_theme_stylebox_override("panel", _make_style(Color(0.024, 0.017, 0.017, 0.84), accent_color, 2, Color(accent_color.r, accent_color.g, accent_color.b, 0.20), 10))
	...
	custom_subtext.add_theme_color_override("font_color", Color("e4d3ad"))
...
func _draw() -> void:
	...
	draw_circle(center, 54.0, Color(accent_color.r, accent_color.g, accent_color.b, 0.09))
	draw_arc(center, 72.0, -0.35, TAU - 0.35, 72, Color(accent_color.r, accent_color.g, accent_color.b, 0.30), 2.0, true)
	draw_arc(center, 58.0, 0.38, TAU + 0.38, 72, Color(0.55, 0.12, 0.08, 0.18), 1.4, true)
